...
class PoseNetworkLongTerm(PoseNetwork):
    ...
    def generate_motion(self, spline, action_prefix, do_print=True, only_rotations=False):
        """
        ...
        Arguments:
         ...
         -- do_print: print elapsed time after generation
         -- only_rotations: only compute and return joint rotations
        """
        with torch.no_grad():
            start_time = time()
